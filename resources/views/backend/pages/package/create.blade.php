                    ...
                    <form action="{{ route('packages.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="airline" class="form-control" value="{{ old('airline') }}">
                                @error('airline')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="hotel_1" class="form-control" value="{{ old('hotel_1') }}">
                                @error('hotel_1')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="hotel_2" class="form-control" value="{{ old('hotel_2') }}">
                                @error('hotel_2')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ziarah" class="form-control" value="{{ old('ziarah') }}">
                                @error('ziarah')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
