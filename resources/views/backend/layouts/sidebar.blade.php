      ...
      <div class="dlabnav">
          <div class="dlabnav-scroll">
              <ul class="metismenu" id="menu">
                  ...
                  <li>
                      <a class="ai-icon" href="{{ route('packages.index') }}" aria-expanded="false">
                  ...
                  <li>
                      <a class="ai-icon" href="{{ route('documentations.index') }}" aria-expanded="false">
                  ...
                  <li>
                      <a class="ai-icon" href="{{ route('setting.edit') }}" aria-expanded="false">
                          <i class="la la-cog"></i>
